...
| **시스템 트레이 우클릭** | 종목 추가 · 관리 · Excel 내보내기·가져오기 · 숨기기 · 마스터 위젯 표시 · 위치 초기화 · 마스터 화면에 정렬 · 도움말 · **앱 정보** · 종료 |
...
| **메뉴바 Pinstock 아이콘 우클릭** | 컨텍스트 메뉴 (종목 추가·관리 · Excel · 자산 정보 숨기기 · 도움말 · **Pinstock 정보** · 종료) |
...
- 수동 확인은 트레이 메뉴(Windows) / 메뉴바 컨텍스트 메뉴(macOS) → **앱 정보 · Pinstock 정보** → **업데이트 확인** 순서로 가능합니다.
