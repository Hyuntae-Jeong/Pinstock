...
from ..core.storage import (
    ...
    merge_account_duplicates, stock_in_account, reconcile_imported_accounts,
...
class WidgetManager:
    ...
    def _load_config(self):
        try:
            ...
            # 한국어 Windows 콘솔은 cp949 라 em-dash 같은 문자는 UnicodeEncodeError 를
            # 낸다. 하필 보호 경로라 로그 한 줄 때문에 가드가 깨지면 안 된다 — ASCII 만.
        ...
        if isinstance(data, list):
            ...
            # 확대 팝업 표시 설정 — 공유 dict 를 제자리 갱신(참조 유지).
